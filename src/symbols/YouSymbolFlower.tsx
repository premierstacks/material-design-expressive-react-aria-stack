...
interface YouSymbolFlowerProps extends Omit<SVGAttributes<SVGSVGElement>, 'style' | 'className' | 'children'> {
  readonly xstyle?: stylex.StyleXStyles;
}

export function YouSymbolFlower({ xstyle, ...props }: YouSymbolFlowerProps): ReactElement {
  return (
    <svg
      {...stylex.props(xstyle)}
      width="100%"
