...
interface YouFlowerShapeProps extends Omit<SVGAttributes<SVGSVGElement>, 'style' | 'children'> {
  xstyle?: stylex.StyleXStyles | undefined;
}

export const YouFlowerShape: FC<YouFlowerShapeProps> = ({ xstyle, ...props }: YouFlowerShapeProps): ReactNode => {
  return (
