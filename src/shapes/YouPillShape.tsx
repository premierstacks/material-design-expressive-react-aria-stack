...
interface YouPillShapeProps extends Omit<SVGAttributes<SVGSVGElement>, 'style' | 'className' | 'children'> {
  readonly xstyle?: stylex.StyleXStyles;
}

export function YouPillShape({ xstyle, ...props }: YouPillShapeProps): ReactElement {
  return (
