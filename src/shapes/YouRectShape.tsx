...
interface YouRectShapeProps extends Omit<SVGAttributes<SVGSVGElement>, 'style' | 'className' | 'children'> {
  readonly xstyle?: stylex.StyleXStyles;
}

export function YouRectShape({ xstyle, ...props }: YouRectShapeProps): ReactElement {
  return (
