...
export interface YouFilledLinkProps extends Omit<LinkProps, 'style' | 'className' | 'children'> {
...
export function YouFilledLink({ symbol, xstyle, label, ...props }: YouFilledLinkProps) {
