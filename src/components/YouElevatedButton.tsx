...
export interface YouElevatedButtonProps extends Omit<ButtonProps, 'style' | 'className' | 'children'> {
...
export function YouElevatedButton({ symbol, xstyle, label, ...props }: YouElevatedButtonProps) {
