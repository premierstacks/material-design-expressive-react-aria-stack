...
export interface YouOutlinedLinkProps extends Omit<LinkProps, 'style' | 'className' | 'children'> {
...
export function YouOutlinedLink({ symbol, xstyle, label, ...props }: YouOutlinedLinkProps) {
