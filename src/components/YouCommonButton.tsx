...
interface YouCommonButtonProps extends Omit<ButtonProps, 'style' | 'className' | 'children'> {
...
export function YouTextCommonButton({ leading, xstyle, label, ...props }: YouCommonButtonProps) {
...
export function YouFilledCommonButton({ leading, xstyle, label, ...props }: YouCommonButtonProps) {
  const ariax = useCallback((args: ButtonRenderProps) => {
    return stylex.props(
      styles.base,
      styles.isFilled,
      ...
      args.isDisabled || args.isPending ? styles.isDisabled : null,
      args.isDisabled || args.isPending ? styles.isDisabledBackground : null,
      xstyle,
    );
  }, [leading, xstyle]);
...
export function YouElevatedCommonButton({ leading, xstyle, label, ...props }: YouCommonButtonProps) {
  const ariax = useCallback((args: ButtonRenderProps) => {
    return stylex.props(
      styles.base,
      styles.isElevated,
...
export function YouTonalCommonButton({ leading, xstyle, label, ...props }: YouCommonButtonProps) {
  const ariax = useCallback((args: ButtonRenderProps) => {
    return stylex.props(
      styles.base,
      styles.isTonal,
...
export function YouOutlinedCommonButton({ leading, xstyle, label, ...props }: YouCommonButtonProps) {
  const ariax = useCallback((args: ButtonRenderProps) => {
    return stylex.props(
      styles.base,
      styles.isOutlined,
