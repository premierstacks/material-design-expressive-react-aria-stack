...
interface YouTildeHorizontalProviderProps extends Omit<SVGAttributes<SVGSVGElement>, 'style' | 'className' | 'children'> {
...
export function YouTildeHorizontalProvider({ xstyle, ...props }: YouTildeHorizontalProviderProps): ReactElement {
  return (
    <svg {...stylex.props(styles.base, xstyle)} aria-hidden="true" width="155" height="9" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
