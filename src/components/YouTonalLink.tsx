...
export interface YouTonalLinkProps extends Omit<LinkProps, 'style' | 'className' | 'children'> {
...
export function YouTonalLink({ symbol, xstyle, label, ...props }: YouTonalLinkProps) {
