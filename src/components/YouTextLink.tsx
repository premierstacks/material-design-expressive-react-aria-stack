...
export interface YouTextLinkProps extends Omit<LinkProps, 'style' | 'className' | 'children'> {
...
export function YouTextLink({ symbol, xstyle, label, ...props }: YouTextLinkProps) {
