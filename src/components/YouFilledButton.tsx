...
export interface YouFilledButtonProps extends Omit<ButtonProps, 'style' | 'className' | 'children'> {
...
export function YouFilledButton({ symbol, xstyle, label, ...props }: YouFilledButtonProps) {
